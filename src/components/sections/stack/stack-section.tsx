...
/**
 * Stack: "the call sheet". The intro on the left from lg, the table on the right (its column headers
 * are the projects' logos, so there is no separate key: Wayne's W22). The table model is built here, on the server; CallSheet is the client island
