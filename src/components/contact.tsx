    ...
    >
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <motion.h2
          ...
          className="text-5xl sm:text-6xl md:text-7xl font-bold mb-12 leading-tight tracking-tight"
        >
        ...
        <div className="inline-flex flex-col items-center">
          <AnimatePresence mode="wait">
            {!isComplete ? (
              ...
              >
                {/* Number display */}
                <div className="glass-strong px-8 py-5 min-w-[280px] sm:min-w-[340px]">
              ...
              >
                {/* Dialed number */}
                <div className="glass-strong px-8 py-5 min-w-[280px] sm:min-w-[340px] shadow-[0_0_30px_rgba(34,197,94,0.15)]">
                  <div className="text-2xl sm:text-3xl font-mono font-semibold tracking-[0.15em] min-h-[40px] flex items-center justify-center">
